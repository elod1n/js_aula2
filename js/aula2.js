function runCalculator() {
    ...
    let dolarValor = parseFloat(prompt(`${nomeUsuario}, qual é a cotação do dólar US$ no dia de hoje (separe a casa decimal com ponto)?`));

    let valorProduto = parseFloat(prompt(`${nomeUsuario}, qual é o valor do produto em reais (R$) que você deseja comprar (separe a casa decimal com ponto)?`));
